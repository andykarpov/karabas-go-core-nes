...
xst -ifn xst.scr
move pllx5_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pllx5_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pllx5_exdes.ucf pllx5_exdes

echo 'Running map'
map -timing -pr b pllx5_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pllx5_exdes -w routed.ncd routed.v
cd ..
