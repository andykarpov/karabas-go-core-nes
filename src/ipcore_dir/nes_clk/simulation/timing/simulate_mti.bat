...
vlog -work work nes_clk_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax nes_clk_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.nes_clk_tb work.glbl
